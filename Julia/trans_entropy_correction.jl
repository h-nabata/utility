function main()
    ...
    # M. Mammen, E. Shakhnovich, J. Deutch, and G. Whitesides, J. Org. Chem. 1998, 63, 12, 3821–3830. https://pubs.acs.org/doi/10.1021/jo970944f

    solv_molecular_vol = 125.412  # 1 / mol  (DMF ... Cavity volume = 125.412 ~ 126.089 Ang**3) (const.))
    solv_molarity = 10.763        # mol / L (const.)
    molecular_mass = 194.21       # g / mol   73.09 ... DMF;  119.38 ... CHCl3
